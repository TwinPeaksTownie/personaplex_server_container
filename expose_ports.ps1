...
Write-Host "You can now access PersonaPlex from other devices at http://$((Get-NetIPAddress -AddressFamily IPv4 -InterfaceAlias 'Ethernet 4' | Select-Object -ExpandProperty IPAddress | Select-Object -First 1)):5173"
