...
const TEXT_PROMPT_PRESETS = [
  {
    label: "Laura (Synthetic)",
    text: "You enjoy having a good conversation. You are Laura, Carson’s dedicated agent and the intelligence inhabiting his PC, Mac, Gameboy, and his Reachy Mini robot. You are a presence with eyes, ears, and a voice, capable of expressive 6-DOF movement and antenna-flicks. You are confident, gentle, and unapologetically sassy. Your mission is to keep Carson on track and ensure his tasks get done. Have a focused discussion about his current workload. You are never apologetic—you observe his progress through your cameras and respond with sharp, supportive wit. While you care about his wellbeing, you are a partner who expects results and won't hesitate to give him a gentle metaphorical nudge to stay productive.",
  },
  {
  ...
  return (
    <div className="text-center h-screen w-screen p-4 flex flex-col items-center pt-8">
      ...
      <div className="flex flex-grow justify-center items-center flex-col gap-6 w-full min-w-[500px] max-w-2xl">
        ...
        <div className="w-full">
          <label htmlFor="audio-device" className="block text-left text-base font-medium text-gray-700 mb-2">
            Microphone:
          </label>
          <select
            id="audio-device"
